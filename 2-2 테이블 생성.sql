...
(
    ...
    TOT_CNT    	NUMBER DEFAULT 0 NOT NULL,
    TOT_AMT    	NUMBER DEFAULT 0 NOT NULL
);
...
(
    ORD_NO    	CHAR(10) NOT NULL,
    BK_NO    	CHAR(10) NOT NULL,
    ORD_CNT    	NUMBER DEFAULT 0 NOT NULL,
    ORD_UPRC    NUMBER DEFAULT 0 NOT NULL,
